...
const dict = {
  ja: {
    ...
    'rd.loading': '本を開いています…',
    'rd.fav': 'ここすき',
    'rd.favAdd': 'ここすき！に追加しました',
    'rd.favRemove': 'ここすき！から外しました',
    'rd.favLocal': 'このブラウザには保存されません',
    'rd.favHint': 'ページを長押しで「ここすき！」',
    'rd.modeHint': 'めくり／スクロールは右上で切り替え',
    'rd.favEmpty': 'まだありません。好きなページを長押ししてください。',
    'rd.pages': 'ページ一覧',
    'rd.all': 'すべて',
    'rd.share': '共有',
    'rd.copied': 'このページのリンクをコピーしました',
    'rd.copyFail': 'コピーできませんでした',
  ...
  en: {
    ...
    'rd.fav': 'FAVES',
    'rd.favAdd': 'ADDED TO FAVES',
    'rd.favRemove': 'REMOVED FROM FAVES',
    'rd.favLocal': "THIS BROWSER WON'T KEEP IT",
    'rd.favHint': 'LONG-PRESS A PAGE TO FAVE IT',
    'rd.modeHint': 'SWITCH FLIP / SCROLL AT THE TOP RIGHT',
    'rd.favEmpty': 'Nothing yet. Long-press any page you love.',
    'rd.pages': 'PAGES',
    'rd.all': 'ALL',
    'rd.share': 'SHARE',
    'rd.copied': 'LINK TO THIS PAGE COPIED',
    'rd.copyFail': "COULDN'T COPY THE LINK",
